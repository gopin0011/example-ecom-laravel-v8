...
INSERT INTO `cart` VALUES (60,NULL,'2022-02-02 08:15:30','2022-02-02 08:15:30',0,'d90d57b414639e23b09a87b5155ee295'),(61,NULL,'2022-02-02 08:17:55','2022-02-02 08:17:55',0,'aaefeec2a3127fdacb3e8f15a5fda618'),(62,NULL,'2022-02-02 08:24:52','2022-02-02 08:24:52',0,'f68d1e9bea8ac3305aa808d66a73e6c3'),(63,NULL,'2022-02-02 08:25:00','2022-02-02 08:25:00',0,'b42f0a72c3ba6d33a148ff4647617f16'),(64,1,'2022-02-02 13:28:49','2022-02-02 09:08:10',0,'6614f9eb4bcf0a859f04f39ab4ff1e7e'),(65,1,'2022-02-02 15:37:47','2022-02-02 15:35:59',0,'c51a3038addc106da6bd5157ce2cf011'),(66,1,'2022-02-02 15:41:43','2022-02-02 15:38:14',0,'0090a6a2203edf18d286dde680edd7a0'),(67,1,'2022-02-02 15:47:48','2022-02-02 15:46:37',0,'db8c661e5a7e83ddab440460c75ff72d');
...
CREATE TABLE `cart_product` (
  ...
  PRIMARY KEY (`id`),
  KEY `cart_product_FK` (`cart_id`),
  KEY `cart_product_FK_1` (`product_id`),
  CONSTRAINT `cart_product_FK` FOREIGN KEY (`cart_id`) REFERENCES `cart` (`id`),
  CONSTRAINT `cart_product_FK_1` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`)
...
INSERT INTO `cart_product` VALUES (28,2,2,2000000,4000000,'2022-02-03 03:15:15','2022-02-03 07:42:30',64),(29,7,1,800000,800000,'2022-02-03 03:15:20','2022-02-03 03:15:20',64),(30,5,1,2800000,2800000,'2022-02-03 03:15:42','2022-02-03 07:42:58',67);
...
INSERT INTO `users` VALUES (1,'Erfin Gustaman','gopin.ipin@gmail.com',NULL,'$2y$10$raSyCW4LBkorEYER4b8rfOPiisKNymVYSRHOzexBxqPLS3dQASqKa','RFehC5vPZRKWVn9tqPPmplPcTMDWDxG2Ka9NmXJmfijrxS4JvJqiPMjKohi0','2022-01-12 21:59:31','2022-01-12 21:59:31',0),(2,'Admin','admin@mail.com',NULL,'$2y$10$PbJiK4wVtFOOLU2bc6T5T.0i8Ae9NZ3iGrt4hZiwipIeaJvop3qvW','z111ACWZY7rKcPPC7y7k5Ct2YkYbSkGWCo3t49PmHzxqSxJfXhC1M7zYZ3dQ','2022-01-12 22:02:21','2022-01-12 22:02:21',1);
...
-- Dump completed on 2022-02-03 14:52:41
