            ...
            <div class="bg-white rounded-3 shadow-lg p-4 ms-lg-auto">
                <div class="py-2 px-xl-2">
                    <div class="widget mb-3">
                        <h1 class="widget-title text-center"><b>Rincian Pemesanan</b></h1>
                        @foreach($carts as $product)
                        <div class="d-flex align-items-center pb-2 border-bottom"><a class="d-block flex-shrink-0" href="{{ route('product', ['id' => $product->id]) }}"><img src="{{ asset('storage/' . $product->thumbnail) }}" width="64" alt="Product"></a>
                        <div class="ps-2">
                            <h6 class="widget-product-title"><a href="{{ route('product', ['id' => $product->id]) }}">{{$product->name}}</a></h6>
